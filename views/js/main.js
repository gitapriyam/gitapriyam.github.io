...
/*
    This function precomputes the Sine vaues
    and later returns the values thru a function call
*/
function computePhaseShift() {
    phaseShiftList = [];
    var scrollTop = document.body.scrollTop / 1250;
    for (var i = 0; i < 5; i++) {
        phaseShiftList.push(Math.sin(scrollTop + i));
    }
}

/*
    This function returns the precomputed Sine values
*/

function getPhaseShift(i) {
    return phaseShiftList[i];
}
...
/*  Ramesh 04/05/2014
    Everytime the window size changes or DOM loaded or scroll happens
    The pizza postions are computed dynamically and added to the
    pizza container. The items in the pizza container are later 
    painted.
*/
...
function updatePizzaPositions() { 
    ...
    for (var i = 0; i < pizzaRows * pizzaCols; i++) {
        ...
        elem.style.basicLeft = document.body.scrollLeft + ((i % pizzaCols) * pizzaBoxWidth);
